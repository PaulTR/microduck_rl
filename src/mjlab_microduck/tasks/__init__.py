...
_BACKLASH_TASKS = (
    ...
    ("Mjlab-Jump-Flat-Backlash-MicroDuck", make_microduck_jump_env_cfg, {}, MicroduckJumpRlCfg, _BL_WALK),
    ("Mjlab-Jump-Rough-Backlash-MicroDuck", make_microduck_jump_env_cfg, {"rough": True}, MicroduckJumpRlCfg, _BL_WALK),
